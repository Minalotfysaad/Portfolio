...
import { MapPin, CheckCircle2, ShieldCheck, Database, Code2, Server } from "lucide-react";
    ...
    <section id="about" className="py-20 lg:py-28 relative bg-[#09090B]">
      <div className="container mx-auto px-4 sm:px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          {/* Left Column: Portrait & Location Card */}
          <div className="lg:col-span-5 flex flex-col items-center lg:items-start">
            <div className="relative w-full max-w-sm">
              {/* Subtle back ambient glow */}
              <div className="absolute -inset-2 bg-gradient-to-tr from-accent/20 to-indigo-600/10 rounded-2xl blur-xl opacity-60 pointer-events-none" />

              {/* Portrait Container */}
              <div className="relative bg-[#111114] border border-border rounded-2xl p-3 shadow-xl">
                <div className="relative aspect-[4/5] w-full rounded-xl overflow-hidden bg-surface border border-border/80 flex items-center justify-center">
                  {!imageError ? (
                    <Image
                    ...
                    /* High-tech Professional Fallback Frame when photo is not uploaded yet */
                ...
                <div className="mt-3 px-2 py-2 flex items-center justify-between font-mono text-xs text-secondary border-t border-border/50">
              ...
              {/* Core Strengths Quick Cards */}
              <div className="mt-4 grid grid-cols-2 gap-2.5 font-mono text-xs">
                <div className="p-3 rounded-lg bg-surface/50 border border-border flex items-center gap-2">
                  <ShieldCheck className="w-4 h-4 text-emerald-400 shrink-0" />
                  <span className="text-foreground text-[11px]">JWT & RBAC</span>
                </div>
                <div className="p-3 rounded-lg bg-surface/50 border border-border flex items-center gap-2">
